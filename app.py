...
def inject_powerpro_ui_css() -> None:
    ...
    .pp-special {height:43px; min-width:0; border-radius:8px; border:2px solid #65c6d6; background:linear-gradient(180deg,#f0fdff 0%,#b8eef4 58%,#83dce7 100%); color:#0871ad; font-weight:900; display:grid; grid-template-columns:minmax(0,1fr); place-items:center; padding:0 8px; font-size:17px; box-shadow:inset 0 1px rgba(255,255,255,.64), inset 0 -1px rgba(83,202,232,.08);}
    ...
    .pp-special.empty {height:43px; background:rgba(230,248,252,.68); border-color:#c3e8f0; color:transparent; box-shadow:none;}
